...
class Loader(object):
    ...
    def write_to_db(self):
        ...
        """
        props = conndb.parse_props("/some/other/dir/config_dev.properties")
...
def main():
    ...
    # searches Gmail for new messages labeled with 'ngo_access_log'
    # search_query = 'label:ngo_access_log after:' + str(date.today()) 
    search_query = 'label:ngo_access_log' 
